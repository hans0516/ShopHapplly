...
#import "ShopHappllyAppDelegate.h"

@implementation ShopHappllyAppDelegate
...
- (BOOL)application:(UIApplication *)application didFinishLaunchingWithOptions:(NSDictionary *)launchOptions
{
    ...
    [[SHDataModel sharedDataModel] getCardsList];
    [[SHDataModel sharedDataModel] getCategoriesList];
    [[SHDataModel sharedDataModel] getMallList];
