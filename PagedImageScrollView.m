...
- (void)setPageControlPos:(enum PageControlPosition)pageControlPos
{
    ...
    }else if (pageControlPos == PageControlPositionCenterBottom)
    {
        ...
        self.pageControl.frame = CGRectMake((self.scrollView.frame.size.width - width) / 2, self.scrollView.frame.size.height+self.scrollView.frame.origin.y - 15, width, PAGECONTROL_HEIGHT);
